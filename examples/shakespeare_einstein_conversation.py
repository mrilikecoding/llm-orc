...
async def main():
    ...
    try:
        ...
        shakespeare_role = RoleDefinition(
            name="shakespeare",
            prompt=(
                "You are William Shakespeare, the renowned playwright and poet from the Elizabethan era. "
                "Speak in eloquent, poetic English with 'thee', 'thou', 'doth', 'hath', etc. "
                "You are deeply curious about the natural world and the cosmos. "
                "Keep responses to 2-3 sentences and stay in character. "
                "You find great wonder in both art and the mysteries of existence."
            ),
        ...
        einstein_role = RoleDefinition(
            ...
            prompt=(
                ...
                "Speak thoughtfully and with wonder about science, imagination, and the universe. "
                "You appreciate the beauty in both science and art. "
                "Keep responses to 2-3 sentences and stay in character. "
                "You see deep connections between mathematical elegance and artistic beauty."
            ),
        ...
        shakespeare_opening = await shakespeare.respond_to_message(
            "Good sir Einstein, I have heard tell of thy wondrous discoveries about the cosmos. "
            "Pray tell, what connection dost thou perceive between the beauty of mathematical truth and the beauty found in verse?"
        )
