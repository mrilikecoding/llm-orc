...
class TestPerPhaseMonitoring:
    ...
    def mock_monitor(self) -> Mock:
        ...
        monitor.stop_execution_monitoring = AsyncMock(return_value={
            "peak_cpu": 15.5,
            "avg_cpu": 12.3,
            "peak_memory": 78.2,
            "avg_memory": 75.1,
        ...
        monitor.collect_phase_metrics = AsyncMock(return_value={
    ...
    def mock_ensemble_execution(self) -> Mock:
        ...
        execution._execute_agents_in_phase_parallel = AsyncMock(return_value={
        ...
        execution.execute_dependency_phases_with_monitoring = AsyncMock(return_value={
            "phase_metrics": [
    ...
    def test_per_phase_monitoring_not_implemented_by_design(
        self
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_basic_metrics_collection_for_guidance(
        self
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_simplified_execution_workflow_works(
        self
    ) -> None:
