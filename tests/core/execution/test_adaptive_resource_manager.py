...
class TestAdaptiveResourceManager:
    ...
    def test_manager_initialization(
        self, manager: AdaptiveResourceManager, monitor_mock: SystemResourceMonitor
    ) -> None:
    ...
    async def test_circuit_breaker_fallback(
        ...
        monitor_mock.get_current_metrics.side_effect = Exception("Monitor failed")  # type: ignore[attr-defined]
