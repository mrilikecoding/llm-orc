...
class TestFormatAdaptiveResourceMetrics:
    ...
    def test_format_adaptive_resource_metrics_with_decisions(self):
    ...
    def test_format_adaptive_resource_metrics_static(self):
    ...
    def test_format_adaptive_resource_metrics_no_decisions(self):
    ...
    def test_format_adaptive_resource_metrics_empty(self):
        """Test formatting with empty stats."""
        result = _format_adaptive_resource_metrics({})
        
        assert result == []

    def test_format_adaptive_resource_metrics_none(self):
        """Test formatting with None stats."""
        result = _format_adaptive_resource_metrics(None)
...
class TestFormatPerPhaseMetrics:
    ...
    def test_format_per_phase_metrics_complete(self):
    ...
    def test_format_per_phase_metrics_minimal(self):
    ...
    def test_format_per_phase_metrics_empty(self):
        """Test formatting empty phase metrics."""
        result = _format_per_phase_metrics([])
        
        assert result == []

    def test_format_per_phase_metrics_none(self):
        """Test formatting None phase metrics."""
        result = _format_per_phase_metrics(None)
...
class TestFormatAdaptiveWithDecisions:
    ...
    def test_format_adaptive_with_decisions_complete(self):
    ...
    def test_format_adaptive_with_decisions_no_decisions(self):
...
class TestFormatAdaptiveDecisionDetails:
    ...
    def test_format_adaptive_decision_details_configured_limit(self):
    ...
    def test_format_adaptive_decision_details_static_limit(self):
    ...
    def test_format_adaptive_decision_details_no_recommendation(self):
    ...
    def test_format_adaptive_decision_details_empty(self):
...
class TestFormatExecutionMetrics:
    ...
    def test_format_execution_metrics_complete(self):
    ...
    def test_format_execution_metrics_cpu_only(self):
    ...
    def test_format_execution_metrics_memory_only(self):
    ...
    def test_format_execution_metrics_empty(self):
...
class TestFormatExecutionSummary:
    ...
    def test_format_execution_summary_complete(self):
    ...
    def test_format_execution_summary_partial(self):
    ...
    def test_format_execution_summary_empty(self):
...
class TestDisplayFunctions:
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics._format_adaptive_resource_metrics')
    def test_display_adaptive_resource_metrics_text(self, mock_format, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_adaptive_resource_metrics_text_empty(self, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics._display_phase_resource_usage')
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics._display_phase_timing')
    def test_display_phase_statistics(self, mock_timing, mock_usage, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_phase_statistics_empty(self, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_phase_resource_usage_complete(self, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_phase_resource_usage_fallback(self, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_phase_timing_with_percentage(self, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_performance_guidance_low_cpu(self, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_performance_guidance_high_resources(self, mock_echo):
    ...
    def test_display_execution_metrics(self, mock_raw, mock_simplified, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_execution_metrics_empty(self, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_simplified_metrics(self, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_raw_samples(self, mock_echo):
    ...
    @patch('llm_orc.cli_modules.utils.visualization.performance_metrics.click.echo')
    def test_display_raw_samples_large_dataset(self, mock_echo):
        """Test displaying raw samples with large dataset (should skip detailed output)."""
        execution_metrics = {
            "sample_count": 5,
