...
**Scope:** Scoped RDD cycle at `docs/agentic-serving/`. Inherits the project-level domain model (Invariants 1-14, AS-1..AS-8 — AS-7 amended Cycle 6) and existing system architecture.
