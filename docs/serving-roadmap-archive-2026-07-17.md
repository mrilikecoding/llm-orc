> **Frozen snapshot (2026-07-17).** This is the serving roadmap exactly as it
> stood before the 2026-07-17 revamp, kept verbatim for provenance: the
> trajectory table, the Arc D correction history (corrections deliberately
> recorded in place), the original workstream prose, and the 2026-07-09 path
> items. The living roadmap is `docs/serving-roadmap.md`. Do not update this
> file.
