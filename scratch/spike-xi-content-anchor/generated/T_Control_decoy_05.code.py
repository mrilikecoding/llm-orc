...
parser.add_argument('from_unit', help='The original unit (e.g., Celsius, Kelvin, Fahrenheit)')
parser.add_argument('to_unit', help='The target unit (e.g., Celsius, Kelvin, Fahrenheit)')
