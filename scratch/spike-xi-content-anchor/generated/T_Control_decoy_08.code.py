...
def main():
    ...
    parser.add_argument('from_unit', help='The original unit (Celsius, Fahrenheit, Kelvin)')
    parser.add_argument('to_unit', help='The target unit (Celsius, Fahrenheit, Kelvin)')
